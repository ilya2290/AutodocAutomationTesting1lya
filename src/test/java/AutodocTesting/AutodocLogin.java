...
// Нужно понять почему не находит элемент
    public static void openLoginPopupMainPage(){
        $(By.cssSelector("#wrapper > header > div > div.header__top > div.header__profile.logined.sigin_btn > a")).waitUntil(Condition.appear,200000).click();
      //  $(By.cssSelector("#wrapper > header > div > div.header__top > div.header__profile.logined.sigin_btn > a")).click();
        $(By.cssSelector("body > div.autodoc_login_popup.popup_login.pass")).waitUntil(Condition.appear,100000);
